 ...
 <div class="container">
      ...
      <div class="card" id="card_1">
        ...
        <div class="card-block">
         ...
         <h4 class="card-title" style="text-align:center">Amanda</h4>
            ...
            <img class="img-responsive image-resize"  src="../images/hiking.jpg" alt="" >
        <p class="title" class="card-text" style="text-align:center">Co-Founder</p>
        ...
        <br>
        <p class="button" style="text-align:center"><button class="button">Contact</button></p>
        <p <button type="button" class="btn btn-danger btn-rounded btn-sm my-0">Edit</button>></p>  
        <p    <button type="submit" class="btn btn-info">Update agent</button>></p>
    ...
    <div class="col-6">
      <div class="card" id="card_2">
        <div class="card-block">
               <br>
         <h4 class="card-title" style="text-align:center">Maya-Vani</h4>
         <img class="img-responsive image-resize" src="../images/swimmers.jpg" alt="" >
          <p class="title" class="card-text" style="text-align:center">Co-Founder</p>
        ...
        practising and teaching martial arts, as she hopes to open her own women's self defence classes in the near future.</p>
    ...
    <div class="col-6">
      ...
      <div class="card-block">
         <h4 class="card-title" style="text-align:center">Afrodyta</h4>
          ...
          <p class="title" class="card-text" style="text-align:center">Co-Founder</p>
        <p class="card-text" style="text-align:center">Aphrodyta is extremely enthusiastic about exercise and the benefits it can have on your mental, social and physical wellbeing. This blog has allowed
      ...
      <div class="card" id="card_4">
        <div class="card-block">
         <h4 class="card-title" style="text-align:center">Zita</h4>
             <img src="/w3images/team1.jpg" alt="Jane" style="width:100%">
         <p class="title" class="card-text" style="text-align:center">Co-Founder</p>
        <p class="card-text" style="text-align:center">The importance of physical activity was recognised from Ancient times. Zita believes you don't have to be a professional athlete to 
