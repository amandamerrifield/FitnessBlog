...
<html lang="en">
 ...
 <!--       <?php //require '../controllers/level_controller.php'; ?> -->
    </head>
        ...
        <div class="row" style="padding-top: 80px;">
            <div class="col-md-2" >
                <nav class="nav nav-pills flex-column">
                    ...
                    <a class="nav-link active" href="views/admin/difficulty/indexLevel.php">Manage Difficulty Levels</a>
            ...
            <div class="col-md-9" >
                ...
                <a href='?controller=difficulty&action=read' class="btn btn-info" id="adminBtn">Manage Level</a>
