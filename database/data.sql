...
INSERT INTO users VALUES (4,false,'hanna99','hanna@gmail.com','password',LOAD_FILE('d:\\flower.gif'),NOW(), NOW(),'Hannah','Hi I am Hannah');
INSERT INTO users VALUES (5, true, 'admin', 'admin@google.com', 'password', LOAD_FILE('/Users/zita/Desktop/FibonacciDualSpiral.png'), DATE('2020-2-20'),NOW(), 'Admin','Hi I am the admin');
